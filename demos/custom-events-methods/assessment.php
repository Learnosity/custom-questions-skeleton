...
<script>
    ...
    window.questionsApp = LearnosityApp.init(activity, {
        readyListener() {
            ...
            const questionInstance = questionsApp.question(activity.questions[0].response_id);

            // Listen to custom events from the custom question instance
            questionInstance.customEvents.on('custom:event', (data) => {
